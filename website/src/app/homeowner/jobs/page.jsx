...
//     router.push(`/homeowner/jobs/${jobId}/edit`);
//   };
...
//     return true; // Jobs can be deleted or cancelled based on backend logic
//   };
...
//                       {/* Job Details */}
//                       <div className="flex flex-wrap gap-4 text-sm text-gray-500 dark:text-zinc-500 mb-4">
...
//                             </div>
//                             <div>
//                               <p className="text-xs text-blue-600 font-semibold">Hired Professional</p>
...
//                         <div className="mt-4 p-4 bg-gray-50 dark:bg-zinc-900 rounded-xl">
...
//                               <div 
//                                 key={index}
//                                 className="flex items-center justify-between p-2 bg-white dark:bg-zinc-800 rounded-lg"
//                               >
//                                 <div className="flex items-center gap-2">
//                                   <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
//                                     {lead.tradesperson?.companyName?.charAt(0) || 
//                                      lead.tradesperson?.user?.name?.charAt(0) || 'T'}
//                                   </div>
//                                   <span className="text-sm font-medium text-gray-900 dark:text-white">
//                                     {lead.tradesperson?.companyName || 
//                                      lead.tradesperson?.user?.name || 'Tradesperson'}
//                                   </span>
//                                 </div>
//                                 {lead.priceEstimate && (
...
//                             ))}
//                             {job.leads.length > 3 && (
//                               <p className="text-xs text-center text-gray-500 dark:text-zinc-500 pt-2">
//                                 +{job.leads.length - 3} more
//                               </p>
//                             )}
//                           </div>
//                         </div>
...
//                   <div className="flex gap-3 mt-4 pt-4 border-t border-gray-100 dark:border-zinc-700">
//                     <Link
//                       href={`/homeowner/jobs/${job._id}`}
...
//                         className="flex-1 text-center px-6 py-3 bg-gradient-to-r from-[#155DFC] to-indigo-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/30"
//                       >
...
//               <p className="text-gray-600 dark:text-zinc-400 mb-6">
//                 Are you sure you want to delete "<strong>{jobToDelete.subCategory?.name}</strong>"?
//                 {jobToDelete.leadCount > 0 && (
//                   <span className="block mt-2 text-sm text-orange-600 dark:text-orange-400">
//                     ⚠️ This job has {jobToDelete.leadCount} quote(s). 
//                     It will be marked as cancelled instead of deleted.
//                   </span>
//                 )}
//               </p>
