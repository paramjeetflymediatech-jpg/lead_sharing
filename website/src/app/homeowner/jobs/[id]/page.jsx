...
//   // Handle navigate to rating page
//   const handleNavigateToRating = () => {
//     router.push(`/homeowner/jobs/${jobId}/rate`);
//   };
...
//   // Check if job has been rated - support multiple field formats
...
//         {/* Quick Action Banner for COMPLETED jobs without rating - ONLY SHOW IF NOT RATED */}
...
//             {/* Show Rating Card for COMPLETED jobs - ONLY IF NOT RATED */}
//             {job.status === "COMPLETED" && !hasBeenRated && (job.hired_tradesperson_name || job.hiredTradespersonName) && (
//               <div className="rounded-3xl border p-6 bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800">
//                 <div className="flex items-center gap-2 mb-4">
//                   <StarIcon className="w-6 h-6 text-amber-600" />
//                   <h3 className="text-lg font-black text-amber-900 dark:text-amber-300">
//                     Pending Rating
...
//             {/* Show Thank You Card for COMPLETED jobs - ONLY IF RATED */}
//             {job.status === "COMPLETED" && hasBeenRated && (job.hired_tradesperson_name || job.hiredTradespersonName) && (
...
//   // Handle marking job as completed - WITH CUSTOM MODAL
//   const handleMarkAsCompleted = async () => {
//     if (!jobId || !user) {
//       toast.error("Please login to update job status");
//       return;
...
//         // Show custom modal for rating prompt
//         setTimeout(() => {
//           if (job.hired_tradesperson_name || job.hiredTradespersonName) {
...
//                   className="flex-1 px-6 py-3 border-2 border-zinc-200 dark:border-zinc-700 text-gray-700 dark:text-zinc-300 font-bold rounded-2xl hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all"
//                 >
//                   Cancel
//                 </button>
//                 <button
//                   onClick={confirmCompletion}
//                   className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-2xl hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg shadow-green-500/30"
//                 >
//                   OK
//                 </button>
//               </div>
...
//               <div className="flex gap-4">
//                 <button
//                   onClick={() => setShowRatePromptModal(false)}
//                   className="flex-1 px-6 py-3 border-2 border-zinc-200 dark:border-zinc-700 text-gray-700 dark:text-zinc-300 font-bold rounded-2xl hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all"
//                 >
//                   Cancel
//                 </button>
//                 <button
//                   onClick={handleNavigateToRating}
//                   className="flex-1 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold rounded-2xl hover:from-amber-600 hover:to-orange-700 transition-all shadow-lg shadow-amber-500/30 flex items-center justify-center gap-2"
//                 >
...
//                 <div className="flex-1">
//                   <h3 className={`text-lg font-black ${
//                     notification.type === "success" ? "text-green-800 dark:text-green-300" : "text-red-800 dark:text-red-300"
//                   }`}>
//                     {notification.title}
//                   </h3>
//                   <p className={`mt-1 ${
...
//         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
//           <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden">
//             <div className="bg-gradient-to-r from-[#155DFC] to-indigo-600 px-8 py-6">
//               <div className="flex items-center justify-between">
...
//                     <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-[#155DFC] to-indigo-600 flex items-center justify-center text-white font-black text-3xl shadow-lg">
//                       {selectedTradesperson.name?.[0]?.toUpperCase() || 'P'}
//                     </div>
//                     <div className="flex-1">
//                       <h4 className="text-2xl font-black text-gray-900 dark:text-white">
//                         {selectedTradesperson.companyName}
//                       </h4>
//                       <p className="text-gray-600 dark:text-zinc-400 mt-1">{selectedTradesperson.name}</p>
//                       <div className="flex items-center gap-4 mt-3">
//                         <div className="flex items-center gap-1">
//                           <StarIconSolid className="w-5 h-5 text-amber-500" />
//                           <span className="font-bold text-gray-900 dark:text-white">
//                             {selectedTradesperson.averageRating}/5
//                           </span>
//                           <span className="text-gray-500 dark:text-zinc-500">
//                             ({selectedTradesperson.totalRatings} reviews)
//                           </span>
//                         </div>
...
//                         <EnvelopeIcon className="w-5 h-5 text-gray-400" />
//                         <div>
//                           <p className="text-sm text-gray-500 dark:text-zinc-500">Email</p>
...
//                         <PhoneIcon className="w-5 h-5 text-gray-400" />
//                         <div>
//                           <p className="text-sm text-gray-500 dark:text-zinc-500">Phone</p>
...
//                       <h5 className="font-bold text-gray-700 dark:text-zinc-300 mb-3">Skills & Expertise</h5>
//                       <div className="flex flex-wrap gap-2">
//                         {selectedTradesperson.skills?.length > 0 ? (
...
//                           ))
//                         ) : (
//                           <p className="text-gray-500 dark:text-zinc-500">No skills listed</p>
//                         )}
//                       </div>
//                     </div>
                    
//                     <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6">
//                       <h5 className="font-bold text-gray-700 dark:text-zinc-300 mb-3">Service Areas</h5>
//                       <div className="flex flex-wrap gap-2">
//                         {selectedTradesperson.serviceAreas?.length > 0 ? (
...
//                           ))
//                         ) : (
//                           <p className="text-gray-500 dark:text-zinc-500">No service areas listed</p>
//                         )}
//                       </div>
//                     </div>
//                   </div>
...
//                     <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6">
//                       <h5 className="font-bold text-gray-700 dark:text-zinc-300 mb-3">About</h5>
//                       <p className="text-gray-700 dark:text-zinc-300 leading-relaxed">
...
//                   {/* Reviews */}
//                   {selectedTradesperson.reviews?.length > 0 && (
//                     <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6">
//                       <h5 className="font-bold text-gray-700 dark:text-zinc-300 mb-3">Recent Reviews</h5>
//                       <div className="space-y-4">
//                         {selectedTradesperson.reviews.slice(0, 2).map((review, index) => (
//                           <div key={index} className="border-b border-gray-200 dark:border-zinc-700 pb-4 last:border-0 last:pb-0">
//                             <div className="flex items-center gap-2 mb-2">
//                               <div className="flex">
//                                 {[...Array(5)].map((_, i) => (
//                                   <StarIconSolid 
//                                     key={i} 
//                                     className={`w-4 h-4 ${i < review.rating ? 'text-amber-500' : 'text-gray-300 dark:text-zinc-700'}`}
//                                   />
//                                 ))}
//                               </div>
//                               <span className="text-sm text-gray-500 dark:text-zinc-500">
//                                 by {review.homeownerName} • {review.date}
//                               </span>
//                             </div>
...
//                         }
//                       }}
//                       className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-2xl hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg shadow-green-500/30 flex items-center justify-center gap-2"
//                     >
            ...
            <div className="p-8 overflow-y-auto max-h-[calc(90vh-120px)]">
              {profileLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  {/* Bio */}
                  {selectedTradesperson.bio && selectedTradesperson.bio !== 'No bio provided' && (
                    <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6 border border-gray-200 dark:border-zinc-700">
                  ...
                  {selectedTradesperson.ratingDistribution && selectedTradesperson.totalRatings > 0 && (
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 rounded-2xl p-6 border border-amber-100 dark:border-amber-900/30">
