      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 dark:text-white font-semibold mt-1">{job.city || job.location?.city || ""}</p>
                        <p className="text-gray-900 dark:text-white font-semibold mt-1">{job.postcode || job.location?.postcode || ""}</p>
                      </div>
                    </div>
            ...
            {/* ── Job Photos ── */}
            <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl shadow-black/5 overflow-hidden">
              <div className="flex items-center gap-3 px-6 sm:px-8 py-5 border-b border-zinc-100 dark:border-zinc-800">
                <PhotoIcon className="w-5 h-5 text-[#155DFC]" />
                <h3 className="text-lg font-black text-gray-900 dark:text-white">
                  Job Photos
                  {(job.images || []).length > 0 && (
                    <span className="ml-2 text-sm font-semibold text-gray-400">({(job.images || []).length})</span>
                  )}
                </h3>
              </div>
              <div className="p-6 sm:p-8">
                {!(job.images || []).length ? (
                  <div className="flex flex-col items-center justify-center py-10 text-center">
                    <PhotoIcon className="w-12 h-12 text-gray-200 dark:text-zinc-700 mb-3" />
                    <p className="text-sm text-gray-400 dark:text-zinc-500">No photos were uploaded for this job</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {(job.images || []).map((url, idx) => (
                      <button
                        ...
                        className="group relative aspect-square rounded-2xl overflow-hidden bg-gray-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-blue-400 transition-all shadow-sm hover:shadow-md"
                      >
                        <img
                          src={url}
                          alt={`Job photo ${idx + 1}`}
                        ...
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/25 transition-colors flex items-center justify-center">
                          <EyeIcon className="w-7 h-7 text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow" />
                        </div>
                      </button>
                    ))}
                  </div>
