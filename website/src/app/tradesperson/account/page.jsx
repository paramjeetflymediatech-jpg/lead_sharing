...
import { Cog6ToothIcon, ShieldCheckIcon, EyeIcon, EyeSlashIcon } from "@heroicons/react/24/outline";
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 bg-white dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-[#1149C7] outline-none pr-10"
                                        placeholder="••••••••"
                                        required
                                    />
                                    <button
