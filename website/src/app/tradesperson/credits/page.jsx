        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-1xl mx-auto">
                Select the perfect plan for your business needs. All plans include full access and premium support.
              </p>
            </div>
              ...
              {Object.entries(PLANS).map(([key, plan]) => {
                ...
                return (
                  ...
                  >
                    {key === 'pro' && (
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                        <div className="px-6 py-2 bg-gradient-to-r from-[#155DFC] to-blue-500 rounded-full text-white text-xs font-bold shadow-lg flex items-center gap-2">
                          <Star className="w-4 h-4" />
                          MOST POPULAR
                        </div>
                      </div>
