...
//     if (!profile || profile.credits < LEAD_COST) {
...
//       return NextResponse.json({ message: "Lead limit reached" }, { status: 400 });
//     }
...
//     if (already) {
//       return NextResponse.json({ message: "Lead already unlocked" }, { status: 400 });
//     }
